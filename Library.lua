...
local Library = {
    ...
    AccentColor = Color3.fromRGB(0, 255, 212);
...
do
    ...
    local KeybindLabel = Library:CreateLabel({
        ...
        Position = UDim2.fromOffset(0.3, 2),
...
function Library:CreateWindow(...)
    ...
    if typeof(Config.Size) ~= 'UDim2' then Config.Size = UDim2.fromOffset(550, 600) end -- Change Size
    ...
    function Window:AddTab(Name)
        ...
        Scrolling_Test1.ScrollBarThickness = 4
